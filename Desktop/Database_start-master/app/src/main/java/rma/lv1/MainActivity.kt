...
fun UserPreview(name: String, visina: Float, tezina: Float, modifier: Modifier = Modifier) {
    ...
    var formattedBmi = String.format("%.2f", bmi)
    ...
    Column(
        ...
        Text(
            text = (newTezina/(newVisina*newVisina)).toString(),
            fontSize = 70.sp,
            lineHeight = 72.sp,
...
fun BackgroundImage(modifier: Modifier) {
    ...
    Box (modifier){ Image(
        ...
        UserPreview(name = "Miljenko", visina = newVisina, tezina = newTezina, modifier = Modifier.fillMaxSize())
    }
